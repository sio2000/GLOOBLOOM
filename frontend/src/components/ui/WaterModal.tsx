    ...
    <AnimatePresence>
      {show && (
        <>
          ...
          >
            <motion.div
              className="w-full max-w-sm max-sm:max-w-none rounded-3xl max-sm:rounded-t-3xl max-sm:rounded-b-none border border-cyan-500/15 bg-[#0a0f0d] max-sm:bg-[#0a0f0d] backdrop-blur-2xl p-8 max-sm:p-6 max-sm:pb-[max(1.5rem,env(safe-area-inset-bottom))] shadow-2xl max-sm:max-h-[min(88dvh,100%)] max-sm:min-h-[min(52dvh,100%)] overflow-y-auto"
